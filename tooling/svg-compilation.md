...
SVG icons are passed through [SVGO](https://github.com/svg/svgo) during compilation. SVGO parameters can be adjusted in [src/config/config-base.js](https://github.com/Eiskis/vue-webpack/blob/master/src/config.base.js).
